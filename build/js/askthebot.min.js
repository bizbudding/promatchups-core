...
document.addEventListener('DOMContentLoaded', function () {
  var chat = document.getElementById('askthebot-chat');
  var form = document.getElementById('askthebot-form');
  var bottom = document.getElementById('chat-bottom');
  var chatDown = document.getElementById('chat-down');
  ...
  // On click listener.
  chatDown.addEventListener('click', function (e) {
    e.preventDefault();
    scrollToBottom();
  });
  ...
  form.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
      var textInput, textOptions, textRandom, imgString, tpmString, formData;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            // Get the input text.
            textInput = document.getElementById('askthebot-question'); // Add the new question to the chat.
            ...
            // Store options.
            textOptions = ['Hold tight, my circuits are buzzing with brilliance!', 'Calculating… or maybe just daydreaming for a second!', 'Give me a sec, my digital brain is working its magic!', 'Fetching brilliance from the AI vault… almost there!', 'Hold on, I’m putting on my thinking cap… virtually!', 'Let me consult my code crystals… response incoming!', 'One moment while I engage super-smart mode!', 'Thinking faster than a speeding algorithm… almost done!', 'Give me a nano-second, still loading my best answer!']; // Built temp HTML.
            textRandom = textOptions[Math.floor(Math.random() * textOptions.length)];
            imgString = '<img src="/wp-content/plugins/promatchups-core/src/img/chad-head.png" alt="robot head with headset" />';
            tpmString = '<div class="askthebot-loading">' + imgString + '<span class="askthebot-loading__text">' + textRandom + '</span><span class="pm-loading-wrap"><svg class="pm-loading" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Pro 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2024 Fonticons, Inc.--><path class="fa-secondary" opacity=".4" d="M478.7 364.6zm-22 6.1l-27.8-15.9a15.9 15.9 0 0 1 -6.9-19.2A184 184 0 1 1 256 72c5.9 0 11.7 .3 17.5 .8-.7-.1-1.5-.2-2.2-.2-8.5-.7-15.2-7.3-15.2-15.8v-32a16 16 0 0 1 15.3-16C266.2 8.5 261.2 8 256 8 119 8 8 119 8 256s111 248 248 248c98 0 182.4-57 222.7-139.4-4.1 7.9-14.2 10.6-22 6.1z"/><path class="fa-primary" d="M271.2 72.6c-8.5-.7-15.2-7.3-15.2-15.8V24.7c0-9.1 7.7-16.8 16.8-16.2C401.9 17.2 504 124.7 504 256a246 246 0 0 1 -25 108.2c-4 8.2-14.4 11-22.3 6.5l-27.8-15.9c-7.4-4.2-9.8-13.4-6.2-21.1A182.5 182.5 0 0 0 440 256c0-96.5-74.3-175.6-168.8-183.4z"/></svg></span></div>'; // Add before form.
            ...
            // Collect form data.
            formData = new FormData(form); // Remove the text input value, after form data is collected.
            textInput.value = '';
            ...
            .then(function (data) {
              ...
              var datePattern = /(\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2}\+\d{2}:\d{2})/g;

              // Replace function to find and convert the dates
              message = message.replace(datePattern, function (match) {
                return dayjs__WEBPACK_IMPORTED_MODULE_1___default()(match).format('MMM D, YYYY @ h:mm a');
              });
              ...
              bottom.insertAdjacentHTML('beforebegin', (0,marked__WEBPACK_IMPORTED_MODULE_0__.marked)(message));
...
/******/ 		var installedChunks = {
/******/ 			"/build/js/askthebot.min": 0,
/******/ 			"build/css/promatchups.min": 0,
/******/ 			"build/css/askthebot.min": 0
/******/ 		};
/******/ 		
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmai_asknews"] = self["webpackChunkmai_asknews"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["build/css/promatchups.min","build/css/askthebot.min"], () => (__webpack_require__("./src/js/askthebot.js")))
/******/ 	__webpack_require__.O(undefined, ["build/css/promatchups.min","build/css/askthebot.min"], () => (__webpack_require__("./src/css/askthebot.css")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["build/css/promatchups.min","build/css/askthebot.min"], () => (__webpack_require__("./src/css/promatchups.css")))
