...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var forms = document.querySelectorAll('.pm-vote__form');
  ...
  forms.forEach(function (form) {
    ...
    form.addEventListener('submit', function (event) {
      ...
      // Get elements.
      var selectedEl = form.querySelector('.pm-outcome__selected');
      var pmNotices = form.querySelectorAll('.pm-notice');
      ...
      if (pmNotices) {
        pmNotices.forEach(function (notice) {
          notice.remove();
        });
      }
...
/******/ 		var installedChunks = {
/******/ 			"/build/js/promatchups-vote.min": 0,
...
/******/ 	__webpack_require__.O(undefined, ["build/css/promatchups.min","build/css/askthebot.min"], () => (__webpack_require__("./src/js/promatchups-vote.js")))
