...
/**
 * The AskNews outcome listener class.
 *
 * @since 0.1.0
 */
class ProMatchups_AskNews_Outcome_Listener extends ProMatchups_Listener {
	protected $outcome;
	protected $body;
	protected $user;
	protected $return;
	...
	function run() {
		...
		$this->body = pm_get_insight_body( $matchup_id );
		...
		$listener = new ProMatchups_Outcome_Votes_Listener( $matchup_id );
